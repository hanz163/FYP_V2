...
Route::middleware(['auth'])->group(function () {
    Route::get('/questions/create/{partID}', [QuestionController::class, 'create'])->name('questions.create');
    ...
    Route::post('/questions/process-ai', [QuestionController::class, 'processWithAI'])->name('questions.processAI');
});
